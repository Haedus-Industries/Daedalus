package project.Daedalus.env;

import project.Daedalus.helpers.ProcessHelper;
import project.Daedalus.utils.FileUtils;
import project.Daedalus.utils.Zipper;
...
public class SetupManager {
    ...
    public static void init() {
        ...
        if (platformTypeName != null && !"".equals(platformTypeName)) {
            if (isLinux()) {
                fileName = "zig-linux-" + platformTypeName + "-0.14.0-dev.2435+7575f2121.tar.xz";
                dirName = "zig-linux-" + platformTypeName + "-0.14.0-dev.2435+7575f2121";
            } else if (isMacOS()) {
                fileName = "zig-macos-" + platformTypeName + "-0.14.0-dev.2435+7575f2121.tar.xz";
                dirName = "zig-macos-" + platformTypeName + "-0.14.0-dev.2435+7575f2121";
            } else if (isWindows()) {
                fileName = "zig-windows-" + platformTypeName + "-0.14.0-dev.2435+7575f2121.zip";
